...
@Injectable()
export class AlertsMutationRateLimitGuard implements CanActivate {
...
@Injectable()
export class AlertsPreviewRateLimitGuard implements CanActivate {
  constructor(private readonly rateLimit: RateLimitService) {}
