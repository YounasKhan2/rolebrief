...
import MarketingLayout from "../shared/shell/MarketingLayout";
import AppShell from "../shared/shell/AppShell";
import CandidateAppShell from "../shared/candidate/CandidateAppShell";
import { RouteFallback } from "./RouteFallback";
import { RequireAuth } from "./RequireAuth";
import { RequireAdmin } from "./RequireAdmin";
import { GuestOnly } from "./GuestOnly";
import { OnboardingLayout } from "../screens/onboarding/OnboardingLayout";
import { OnboardingGate } from "../screens/auth/components/OnboardingGate";
...
export const router = createBrowserRouter([
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    children: [
      ...
      { path: "sources-methodology", lazy: () => import("../screens/marketing/MethodologyScreen") },
  ...
  /*  CATCH-ALL 404                                                     */
  /* ------------------------------------------------------------------ */
  { path: "*", lazy: () => import("./NotFoundScreen") },
]);
